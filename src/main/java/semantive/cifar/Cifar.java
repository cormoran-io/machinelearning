package semantive.cifar;
// package kaggle.cifar;
//
// import java.io.File;
...
//
//// https://semantive.com/deep-learning-examples/
// public class Cifar {
//
...
// testInput.add(trainAndTest.getTest().getFeatures());
...
// .list(6)
// .layer(0,
// new ConvolutionLayer.Builder(new int[] { 5, 5 }).nIn(1)
// .nOut(20)
// .stride(new int[] { 1, 1 })
...
// .layer(2,
// new ConvolutionLayer.Builder(new int[] { 5, 5 }).nIn(20)
// .nOut(40)
// .stride(new int[] { 1, 1 })
// .activation(Activation.RELU)
// .weightInit(WeightInit.XAVIER)
...
// .layer(4,
// new DenseLayer.Builder().nIn(40 * 5 * 5)
// .nOut(1000)
// .activation(Activation.RELU)
// .weightInit(WeightInit.XAVIER)
// .dropOut(0.5)
// .build())
// .layer(5,
// new OutputLayer.Builder(LossFunctions.LossFunction.MSE).nIn(1000)
// .nOut(LABELS.size())
// .dropOut(0.5)
// .weightInit(WeightInit.XAVIER)
// .build())
...
// RecordReader imageReader = new ImageRecordReader(32, 32
// // , false
// );
// imageReader
// .initialize(new FileSplit(new File(System.getProperty("user.home"), "/deep-learning/data/cifar/img")));
//
// RecordReader labelsReader = new CSVRecordReader();
// labelsReader.initialize(
// new FileSplit(new File(System.getProperty("user.home"), "/deep-learning/data/cifar/labels.csv")));
//
